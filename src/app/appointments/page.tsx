...
function DayAppointmentCard({
  ...
  return (
    <div
      className={`relative flex flex-col gap-4 p-4 md:p-5 rounded-2xl border border-[var(--color-wa-sep)] bg-[var(--color-wa-panel-l)] animate-in shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-200 overflow-hidden ${
    ...
    >
      ...
      {/* Main Container */}
      <div className="flex-1 flex flex-col gap-3 pl-2.5">
        {/* Top section: Time slot and Status Badges */}
        <div className="flex items-center justify-between gap-2 flex-wrap">
          {/* Time Badge */}
          <div className="flex items-center gap-1.5 bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800 py-1 px-3 rounded-full">
            <svg className="w-3.5 h-3.5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="text-xs font-bold text-[var(--color-wa-text-main)]">
          ...
          <div className="flex items-center gap-1.5">
            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${STATUS_STYLES[a.status]}`}>
        ...
        {/* Info row: Initials Avatar and client/service details */}
        ...
        {/* Notes Box */}
        {a.notes && (
          <div className="bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/80 p-3 rounded-xl text-xs italic text-[var(--color-wa-text-sec)] mt-1">
        ...
        {/* Actions Bar */}
        <div className="flex items-center justify-between border-t border-[var(--color-wa-sep)] pt-3.5 mt-2 gap-2 flex-wrap">
          {/* Main Action Buttons */}
